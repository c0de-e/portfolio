...
export default async function Header() {
    return (
        <div className="header flex w-auto mx-0 sticky top-0 drop-shadow h-14">
            <nav className="navigation flex-1 items-center justify-end join mr-4 gap-4 sm:gap-3 md:gap-4 lg:gap-6 xl:gap-8">
